...
Monitoreo local para aprender metricas, dashboards y observabilidad.
...
```bash
cd herramientas/prometheus-grafana
...
- `PROMETHEUS_PORT=9090` expone el puerto interno `9090`.
- `GRAFANA_PORT=3005` expone el puerto interno `3000`.
