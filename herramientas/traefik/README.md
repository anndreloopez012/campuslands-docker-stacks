...
Proxy moderno con dashboard para aprender enrutamiento de servicios.
...
- `TRAEFIK_HTTP_PORT=8083` expone el puerto interno `80`.
- `TRAEFIK_DASHBOARD_PORT=8082` expone el puerto interno `8080`.
