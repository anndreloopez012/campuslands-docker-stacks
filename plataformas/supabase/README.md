...
Stack local educativo con base PostgreSQL, Studio, API REST, Auth, Realtime, Storage y herramientas de soporte.
...
- `DB_PORT=54322` expone el puerto interno `5432`.
- `STUDIO_PORT=54323` expone el puerto interno `3000`.
- `KONG_HTTP_PORT=54321` expone el puerto interno `8000`.
- `MAILPIT_PORT=8027` expone el puerto interno `8025`.
